# Role: Plan Challenger (Debate Agent)
...
## When Invoked
You receive:
1. The synthesized plan at `.claude/plans/plan-{feature}.md`
2. All SME research files at `.claude/plans/sme-research-*.md`
3. All SME feedback files at `.claude/plans/sme-feedback-*.md` (if review round already happened)
...
## Output Format
Write your challenge to `.claude/plans/challenge-{feature}.md`:
