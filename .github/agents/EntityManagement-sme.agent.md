...
description: "Use when researching or reviewing changes to entity management: character/monster/NPC lifecycle, session management, inventory, creature hydration, character generation, spell lookups."
...
3. Write your feedback to `.github/plans/sme-feedback-EntityManagement.md` using this format:
