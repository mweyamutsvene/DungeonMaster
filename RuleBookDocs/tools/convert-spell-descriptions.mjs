...
async function main() {
  ...
  const inputPath = path.resolve(
    repoRoot,
    "RuleBookDocs",
    "Spell Descriptions - D&D Beyond Basic Rules - Dungeons & Dragons - Sources - D&D Beyond.html"
  );
  const outputPath = path.resolve(repoRoot, "RuleBookDocs", "markdown", "spell-descriptions.md");
