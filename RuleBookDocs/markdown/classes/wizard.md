...
- Gain the Wizard’s level 1 features (see Wizard Features table).

**As a Multiclass Character**
- Gain the Hit Point Die from the Core Wizard Traits table.
- Gain the Wizard’s level 1 features (see Wizard Features table). See the multiclassing rules in “Creating a Character” to determine your available spell slots.
