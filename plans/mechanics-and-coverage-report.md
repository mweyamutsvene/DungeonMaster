...
| 10 | **Missing class feature executors** (grouped) | ClassAbilities | Divine Spark (Cleric), Sear Undead (Cleric L5), Wild Shape stat-block swap (Druid, currently temp-HP hack), Slow Fall (Monk L4), Innate Sorcery (Sorc L1), Sorcerous Restoration (Sorc L5), Magical Cunning (Warlock L2), Arcane Recovery executor file (Wizard), Ritual Adept (Wizard L1), Tactical Mind (Fighter L2 2024), Tactical Shift (Fighter L5 2024), Steady Aim (Rogue L2 2024), Cunning Strike dedicated executor (Rogue L5 2024). |
...
| 13 | **Monster catalog gap fill** | EntityManagement | Missing: Knight, Orc, Kobold, Wolf, Dire Wolf, Giant Spider, Ogre (living — only Ogre Zombie present), Gnoll, Ghoul, Wight, Owlbear, Brown Bear. |
